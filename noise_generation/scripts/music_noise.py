...
def apply_music_noise(clean_audio_files, no_silences_directory, noise_directory, ids, output_top_dir):
    ...
    for snr in snrs:
        ...
        for clean_audio_file in clean_audio_files:
            ...
            add_music_noise_to_file_stereo(input_file=clean_audio_file, 
...
def apply_music_noise_to_corpus_testset():
    ...
    output_top_dir = os.path.join(rootdir, "music")
    ...
    apply_music_noise(clean_audio_files, no_silences_directory, noise_directory, test_ids, output_top_dir)


def add_music_noise_to_file_stereo(input_file, no_silences_directory, output_file, noise_files, snr_dbs, repeat=False):
...
if __name__ == "__main__":
    # apply_music_noise_to_corpus_testset()
    noise_files = glob.glob("/home/russelsa@ad.mee.tcd.ie/github/noise_generation/data/short-musan/music/fma-merged/*.wav")
    add_music_noise_to_file_stereo(
        input_file="/data/ssd2/russelsa/candor_wav/1f7e582c-c6bc-46b6-b5a4-e5d78e8a46ac.wav",
        no_silences_directory="/data/ssd4/russelsa/candor_utts/silences_removed",
        output_file="/home/russelsa@ad.mee.tcd.ie/github/Multimodal_Turn_Taking/sample_data/0db_music.wav",
        noise_files=noise_files,
        snr_dbs=0
    )
