...
if __name__ == "__main__":    
    ...
    video_directory = '/data/ssd3/russelsa/candor_openface_pkl/'
    video_format = '.pkl' 
    ...
    # train K folds
    folds_dir = f"dataset_management/dataset_manager/assets/new_folds/{corpus}"
